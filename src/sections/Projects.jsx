...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      live: 'https://hire-ready-six.vercel.app/',
      featured: true,
    },
    {
      title: 'Dev Collab (Group Project)',
      description: 'A full-stack, real-time collaboration platform purpose-built for student developer teams.',
      longDescription: 'DevCollab is a GitHub-meets-Notion-meets-Slack platform designed for fast-moving teams. Built for DevFusion Hackathon 2.0 with Team Bug Smashers. Features include Kanban boards, team wiki, code snippet manager, real-time whiteboarding, and an AI project assistant for code reviews and standups.',
      challenges: [
        'Implementing real-time state synchronization via Socket.IO and Supabase Realtime.',
        'Integrating an AI project assistant and AI-powered collaborative whiteboard analysis.',
        'Developing a functional payment sandbox with Stripe-like checkout flows.'
      ],
      image: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=600&h=400&fit=crop',
      tags: ['React', 'Node.js', 'Supabase', 'Socket.IO'],
      category: 'fullstack',
